...
def run_test_go_straight_for_seconds():
    ...
    # -------------------------------------------------------------------------
    robot=SimpleRoseBot()
    robot.go_straight_for_seconds(3,80)
...
def run_test_go_straight_for_inches():
    ...
    # -------------------------------------------------------------------------
    robot=SimpleRoseBot()
    robot.go_straight_for_inches(10,40)
...
class SimpleRoseBot(object):
    ...
    def __init__(self):
        ...
        self.color_sensot=ColorSensor(3)
    ...
    def go_straight_for_inches(self,inches,speed):
        ...
        while True:
            ...
            if (current_position-start)/360*(1.3*math.pi) >= inches:
                break
        self.stop()

    def go_straight_until_black(self,speed):
        color=self.color_sensot.get_reflected_light_intensity()
        self.go(speed,speed)
        while True:
            current_color=self.color_sensot.get_reflected_light_intensity()
            if current_color <= 5:
                break
        self.stop()
